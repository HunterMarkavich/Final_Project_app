...
public class SalespersonSearchScreen extends AppCompatActivity implements SalespersonEditListingOverlay.OnListingUpdatedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_salesperson_search_screen);
    ...
    {
        Log.d("SalespersonSearchScreen", "Search clicked");
        ...
        Log.d("SalespersonSearchScreen", "Listings found: " + listings.size());
        ...
        else
        {
            ...
            {
                listingAdapter = new ListingAdapter(this, listings, true, false);
                rvSearchResults.setAdapter(listingAdapter);

                listingAdapter.setOnItemClickListener(listing ->
                {
                    SalespersonEditListingOverlay overlay = SalespersonEditListingOverlay.newInstance(listing.getId());
                    overlay.show(getSupportFragmentManager(), "SalespersonEditListingOverlay");
                });
            }
            else
            {
    ...
    {
        Intent intent = new Intent(SalespersonSearchScreen.this, SalespersonHomeScreen.class);
